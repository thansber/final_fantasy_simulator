var CharBuilder = (function() {
  ...
  var charClassMapping = {
     Fi : CharacterClass.KNIGHT
    ,Th : CharacterClass.NINJA 
    ,BB : CharacterClass.MASTER 
    ,RM : CharacterClass.RED_WIZARD 
    ,WM : CharacterClass.WHITE_WIZARD 
    ,BM : CharacterClass.BLACK_WIZARD 
  };
  
  var charClassSettings = {};
  charClassSettings[CharacterClass.KNIGHT] = {
    name : "Knight"
  ...
  charClassSettings[CharacterClass.NINJA] = {
    name : "Ninja"
  ...
  charClassSettings[CharacterClass.MASTER] = {
    name : "Master"
  ...
  charClassSettings[CharacterClass.RED_WIZARD] = {
    name : "RedWiz"
  ...
  charClassSettings[CharacterClass.WHITE_WIZARD] = {
    name : "WhiteWiz"
  ...
  charClassSettings[CharacterClass.BLACK_WIZARD] = {
    name : "BlackWiz"
  ...
  var setupGroup = function(charClasses, groupNum) {
    ...
    for (var c in charClasses) {
      ...
      var ffChar = Character.create().name(name).charClass(charClass);
